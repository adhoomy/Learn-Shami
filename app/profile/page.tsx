      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <AnimatedCard delay={4}>
            <Card className="hover:scale-105 transition-all duration-300 bg-white border-gray-200 shadow-lg hover:shadow-xl">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <Button variant="outline" className="w-full text-primary-600 border-primary-200 hover:bg-primary-50 hover:scale-105 transition-all duration-200">
            ...
            <Card className="hover:scale-105 transition-all duration-300 bg-white border-gray-200 shadow-lg hover:shadow-xl">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <Button variant="outline" className="w-full text-accent-600 border-accent-200 hover:bg-accent-50 hover:scale-105 transition-all duration-200">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/review">
                    <Button 
                      size="lg" 
                      variant="outline"
                      className="border-white text-white hover:bg-white hover:text-primary-600 transition-all duration-200 px-6 py-3 text-lg font-medium rounded-xl"
                    >
