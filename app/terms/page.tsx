      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600">Our terms and conditions for using Lean to Falasteen</p>
          </div>
        </div>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <p className="text-gray-700">
              By accessing and using Lean to Falasteen, you accept and agree to be bound by the terms and provision of this agreement. 
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700">
                Permission is granted to temporarily access Lean to Falasteen for personal, non-commercial transitory viewing only. 
                This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
              <ul className="space-y-2 text-gray-700 ml-4">
                <li>• Modify or copy the materials</li>
                <li>• Use the materials for any commercial purpose</li>
                <li>• Attempt to reverse engineer any software contained on Lean to Falasteen</li>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700">
                ...
                Lean to Falasteen and its licensors. The Service is protected by copyright, trademark, and other laws.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-700">
                In no event shall Lean to Falasteen, nor its directors, employees, partners, agents, suppliers, or affiliates, 
