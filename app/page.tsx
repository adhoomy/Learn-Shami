                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-display text-slate-900 mb-2">
                          {stat.value}
                        </p>
            ...
            <CardContent className="p-8 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <Link href="/lessons">
                  <Button 
                    size="lg" 
                    className="bg-white text-primary-600 hover:bg-slate-100 hover:scale-105 transition-all duration-200 px-8 py-4 text-lg font-medium rounded-2xl shadow-lg"
                  >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-slate-900">{lesson.progress}%</span>
                      </div>
