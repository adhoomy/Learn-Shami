      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Card className="hover:scale-105 transition-all duration-300 cursor-pointer bg-white border-gray-200 shadow-lg hover:shadow-xl">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <Button 
                    className="w-full bg-primary-500 hover:bg-primary-600 text-white hover:scale-105 transition-all duration-200"
            ...
            <Card className="hover:scale-105 transition-all duration-300 cursor-pointer bg-white border-gray-200 shadow-lg hover:shadow-xl">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <Button 
                    variant="outline"
                    className="w-full text-accent-600 border-accent-200 hover:bg-accent-50 hover:scale-105 transition-all duration-200"
